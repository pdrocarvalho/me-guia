        ...
        <IonModal isOpen={showSpecs} cssClass="edit-modal">
          <IonContent className="ion-padding">
            <div className='header-modal'>
              ...
              <a className='info'>Delete as informações do ponto turístico aqui:</a>
            </div>
            ...
            <IonButton expand='block' color='danger' onClick={() => {deletePoint(placeSelected.id)}}>DELETAR PONTO</IonButton>
          </IonContent>
        </IonModal>
      </IonContent>
    </IonPage>
