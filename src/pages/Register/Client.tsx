    ...
    return (
        <IonPage>
            ...
            <IonContent className="ion-padding">
                ...
                <IonInput placeholder="Nome fantasia" className="primary-input" onIonChange={(e: any) => setNewStoreName(e.target.value)}></IonInput>
                <IonInput placeholder="CNPJ" className="primary-input" onIonChange={(e: any) => setNewCnpj(e.target.value)}></IonInput>
                <IonInput placeholder="Endereço" className="primary-input" onIonChange={(e: any) => setNewAddress(e.target.value)}></IonInput>
                <IonInput placeholder="Image" className="primary-input" onIonChange={(e: any) => setNewImg(e.target.value)}></IonInput>
                <IonTextarea rows={6} cols={20} placeholder="Descrição" className="primary-input" onIonChange={(e: any) => setNewDescription(e.target.value)}></IonTextarea>


                <IonItem>
                    <IonLabel>Tipo de serviço:</IonLabel>
                    <IonSelect placeholder="Select One" value={chooseType} onIonChange={e => setNewType(e.detail.value)}>
                ...
                <IonButton expand="block" className="ion-margin-top button" onClick={updateInfo} >ENVIAR</IonButton>
            </IonContent>
        </IonPage>
    );
};
